...
class TrialPaywallController: UIViewController {
    ...
    private let privacyButton = PWLBottomButton(title: "Privacy Policy")
    private let restoreButton = PWLBottomButton(title: "Restore")
    private let termsButton   = PWLBottomButton(title: "Terms of Use")
    ...
    private func setupBackground() {
        backgroundImageView.image = UIImage(named: "pwl1")
    ...
    private func setupTextView() {
        let fullText = """
        Get a trusted detector of devices without limits with a risk-free 3-days free trial, then $8.99/week or proceed with a limited version
        """
        let linkText = "or proceed with a limited version"
        
        let attributedString = NSMutableAttributedString(string: fullText, attributes: [
            .font: UIFont.plusJakartaSans(.regular, size: 17),
